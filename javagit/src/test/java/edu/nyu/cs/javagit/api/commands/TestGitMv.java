    ...
    public void testGitMvInvalidInput() throws IOException, JavaGitException {
        ...
        try {
            ...
            assertEquals("Should have null pointer exception or illegal argument exception",
                    ExceptionMessageMap.getMessage("000003") + "  { variableName=[repository path] }", e.getMessage());
        }
        ...
        try {
            ...
            assertEquals("Should have null pointer exception or illegal argument exception",
                    ExceptionMessageMap.getMessage("000005") + "  { variableName=[sources] }", e.getMessage());
        }
        ...
        try {
            ...
            assertEquals("Should have null pointer exception or illegal argument exception",
                    ExceptionMessageMap.getMessage("000003") + "  { variableName=[destination] }", e.getMessage());
        }
