...
public interface IGitAdd {
     ...
     * @param paths List of file paths that are going to be added to the index.
     ...
     * 
     * @param repositoryPath File path pointing to the root of the repository.
     * @param file File will added to the index.
     * @return GitAddResponse object.
     * @throws JavaGitException Thrown when there is an error while running the add command.
     * @throws IOException There are many reasons for which an <code>IOException</code> may be thrown. Examples include:
     *         <ul>
     ...
     * @return GitAddResponse object.
     * @throws JavaGitException Thrown when there is an error while running the add command.
     * @throws IOException\ There are many reasons for which an <code>IOException</code> may be thrown. Examples
     *         include:
     *         <ul>
     *         <li>a directory doesn't exist</li>
     *         <li>access to a file is denied</li>
     ...
     *         </ul>
     */
    public GitAddResponse add(File repositoryPath, List<File> paths) throws JavaGitException, IOException;
