...
public interface IGitClone {
    ...
    /**
     * Clones a git repository, without any option, in default directory i.e. the directory name which the URL contains.
     * 
     ...
     * @throws JavaGitException Thrown when there is an error executing git-clone.
     */
    public GitCloneResponse clone(File workingDirectoryPath, URL repository, File directory) throws IOException,
            JavaGitException;
     ...
     * @throws JavaGitException Thrown when there is an error executing git-clone.
     */
    public GitCloneResponse clone(File workingDirectoryPath, GitCloneOptions options, URL repository, File directory)
            throws IOException, JavaGitException;
}
