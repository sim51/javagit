...
public class TestGitStatusOptions extends TestCase {
    ...
    /**
     * Test for IllegalArgumentException is thrown when -a and -o options are used together in a git-status command.
     */
    @Test
    ...
    /**
     * Test for IllegalArgumentException is thrown when -a and -o options are used together in a &lt;git-status&gt;
     * command. This time opt-only is set before opt-all option
     */
    @Test
    ...
    /**
     * Test for IllegalArgumentException is thrown when all(-a) and include(-i) options are used together in a
     * &lt;git-status&gt; command. This time opt-include is set before opt-all option
     */
    @Test
    ...
    /**
     * Test for IllegalArgumentException is thrown when all(-a) and include(-i) options are used together in a
     * &lt;git-status&gt; command. This time opt-all is set before opt-include option
     */
    @Test
