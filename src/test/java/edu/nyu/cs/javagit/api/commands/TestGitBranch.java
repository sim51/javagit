...
public class TestGitBranch extends TestCase {
    ...
    public void testCreateBranchBadArugmentPassing() throws IOException, JavaGitException {
        ...
        assertCreateBranchNPEThrown(null, null, "000003: An Object argument was not specified but is required.  "
                + "{ variableName=[repository path] }");
        assertCreateBranchNPEThrown(new File("SomePath"), null,
                "000003: An Object argument was not specified but is required.  " + "{ variableName=[branch name] }");
        ...
        assertCreateBranchIllegalArgumentExceptionThrown(new File("SomePath"), Ref.createBranchRef("ref"), new Ref(),
        ...
        assertCreateBranchWithOptsNPEThrown(new File("SomePath"), new GitBranchOptions(), null,
                "000003: An Object argument was not specified but is required.  " + "{ variableName=[branch name] }");
        assertCreateBranchOptsWithIllegalArgumentExceptionThrown(new File("SomePath"), new GitBranchOptions(),
                new Ref(), "100000: Incorrect refType type.  { variableName=[branch name] }");
        assertCreateBranchIllegalArgumentExceptionThrown(new File("SomePath"), Ref.createBranchRef("ref"), new Ref(),
                "100000: Incorrect refType type.  { variableName=[start point] }");
    }
    ...
    public void testBranchBadArugmentPassing() throws IOException, JavaGitException {
        ...
        assertBranchNPEThrown(null, "000003: An Object argument was not specified but is required.  "
                + "{ variableName=[repository path] }");
        assertBranchWithOptsNPEThrown(null, null, "000003: An Object argument was not specified but is required.  "
                + "{ variableName=[repository path] }");
    ...
    public void testRenameBranchBadArugmentPassing() throws IOException, JavaGitException {
        // GitBranch.branch(File)
        assertRenameBranchNPEThrown(null, null, "000003: An Object argument was not specified but is required.  "
                + "{ variableName=[repository path] }");
        assertRenameBranchNPEThrown(new File("FileOne"), null,
                "000003: An Object argument was not specified but is required.  " + "{ variableName=[new name] }");
        ...
        assertRenameBranchWithOldBranchNPEThrown(new File("SomePath"), null, null,
                "000003: An Object argument was not specified but is required.  " + "{ variableName=[old name] }");
        ...
        assertRenameBranchWithOldBranchIllegalArgumentExceptionThrown(new File("SomePath"), new Ref(), new Ref(),
                "100000: Incorrect refType type.  { variableName=[old name] }");
        assertRenameBranchWithOldBranchIllegalArgumentExceptionThrown(new File("SomePath"), Ref.createBranchRef("ref"),
                new Ref(), "100000: Incorrect refType type.  { variableName=[new name] }");
    }

    @Test
    public void testDeleteBranchBadArugmentPassing() throws IOException, JavaGitException {
        // GitBranch.branch(File)
        assertDeleteBranchNPEThrown(null, null, "000003: An Object argument was not specified but is required.  "
                + "{ variableName=[repository path] }");
        ...
        assertDeleteBranchIllegalArgumentExceptionThrown(new File("SomePath"), new Ref(),
                "100000: Incorrect refType type.  { variableName=[branch name] }");
        assertDeleteBranchListNPEThrown(null, null, "000003: An Object argument was not specified but is required.  "
                + "{ variableName=[repository path] }");
    ...
    private void assertCreateBranchNPEThrown(File repoPath, Ref branchName, String expectedMessage) {
        try {
            ...
            assertEquals("The message from the caught NPE is not what was expected!", expectedMessage, e.getMessage());
        } catch (Throwable e) {
            e.printStackTrace();
    ...
    private void assertCreateBranchIllegalArgumentExceptionThrown(File repoPath, Ref branchName, Ref startPoint,
        ...
        try {
            ...
            assertEquals("The message from the caught IllegalArgumentException is not what was expected!",
    ...
    private void assertCreateBranchWithOptsNPEThrown(File repoPath, GitBranchOptions options, Ref branchName,
            String expectedMessage) {
        try {
    ...
    private void assertCreateBranchOptsWithIllegalArgumentExceptionThrown(File repoPath, GitBranchOptions options,
    ...
    private void assertBranchWithOptsNPEThrown(File repoPath, GitBranchOptions options, String expectedMessage) {
        try {
    ...
    private void assertRenameBranchWithOldBranchNPEThrown(File repoPath, Ref oldBranch, Ref newBranch,
            String expectedMessage) {
        try {
    ...
    private void assertRenameBranchIllegalArgumentExceptionThrown(File repoPath, Ref newBranch, String expectedMessage) {
        try {
    ...
    private void assertRenameBranchWithOldBranchIllegalArgumentExceptionThrown(File repoPath, Ref oldBranch,
    ...
    private void assertDeleteBranchListNPEThrown(File repoPath, List<Ref> branchList, String expectedMessage) {
        try {
    ...
    private void assertDeleteBranchIllegalArgumentExceptionThrown(File repoPath, Ref branchName, String expectedMessage) {
        try {
            branch.deleteBranch(repoPath, false, false, branchName);
            assertTrue("No IllegalArgumentException thrown when one was expected.  Error!", false);
        } catch (IllegalArgumentException e) {
    ...
    private void assertDeleteBranchListIllegalArgumentExceptionThrown(File repoPath, List<Ref> branchList,
            String expectedMessage) {
        try {
            branch.deleteBranch(repoPath, false, false, branchList);
            assertTrue("No IllegalArgumentException thrown when one was expected.  Error!", false);
