...
public class TestGitCheckout extends TestCase {
    ...
    public void testCreatingNewBranchFromMaster() throws IOException, JavaGitException {
        ...
        assertEquals("New Branch created should be created with name- testBranch", "\"testBranch\"", response
                .getNewBranch().getName());
    }
    ...
    /**
     * Test for checking out a file from another branch. A new branch testBranch01 is created with base as master, and a
     * new test file foobar03 is created and committed to the repository in testBranch01. Now another branch
     * testBranch02 is created from master branch and file foobar03 should not be existing in current branch
     * testBranch02. We checkout this file from testBranch01 and verify that the file exists after checking out from
     * testBranch01.
     * 
     * @throws JavaGitException
     * @throws IOException
