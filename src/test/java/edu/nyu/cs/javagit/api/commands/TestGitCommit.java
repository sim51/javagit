...
public class TestGitCommit extends TestCase {
     ...
     * 
     * commands -- add, move(same dir, different dir in same tree, totally different dir), delete, copy (same as for
     * move), just edits
     * 
    ...
    public void testBadArugmentPassing() throws IOException, JavaGitException {
        ...
        assertCommitAllNPEThrown(null, null, "000003: An Object argument was not specified but is required.  "
        ...
        assertCommitWithOptsNPEThrown(null, null, null,
                "000003: An Object argument was not specified but is required.  " + "{ variableName=[repository] }");
        ...
        assertCommitAllParametersNeededIllegalArgumentExceptionThrown(new File("c:\\path\\to somewhere"), null, "",
                null, "000001: A String argument was not specified but is required.  { variableName=[message] }");
        paths.clear();
        assertCommitAllParametersNeededIllegalArgumentExceptionThrown(new File("/some/path"), options, "A message",
                paths, "000005: An List<?> argument was not specified or is empty but is required.  "
                        + "{ variableName=[paths] }");

        // GitCommit.commit(String, String);
        assertCommitNPEThrown(null, null, "000003: An Object argument was not specified but is required.  "
                + "{ variableName=[repository] }");
        ...
        assertCommitOnlyNPEThrown(null, null, null, "000003: An Object argument was not specified but is required.  "
                + "{ variableName=[repository] }");
    ...
    private void assertCommitAllIllegalArgumentExceptionThrown(File repoPath, String message, String expectedMessage) {
        try {
            commit.commitAll(repoPath, message);
    ...
    private void assertCommitWithOptsNPEThrown(File repoPath, GitCommitOptions options, String message,
    ...
    private void assertCommitWithOptsIllegalArgumentExceptionThrown(File repoPath, GitCommitOptions options,
    ...
    private void assertCommitAllParametersNeededNPEThrown(File repoPath, GitCommitOptions options, String message,
    ...
    private void assertCommitAllParametersNeededIllegalArgumentExceptionThrown(File repoPath, GitCommitOptions options,
    ...
    private void assertCommitIllegalArgumentExceptionThrown(File repoPath, String message, String expectedMessage) {
        try {
            commit.commit(repoPath, message);
            fail("No IllegalArgumentException thrown when one was expected.  Error!");
        } catch (IllegalArgumentException e) {
    ...
    private void assertCommitOnlyNPEThrown(File repoPath, String message, List<File> paths, String expectedMessage) {
        try {
    ...
    private void assertCommitOnlyIllegalArgumentExceptionThrown(File repoPath, String message, List<File> paths,
            String expectedMessage) {
        try {
            commit.commitOnly(repoPath, message, paths);
            fail("No IllegalArgumentException thrown when one was expected.  Error!");
