 ...
 */
public class GitMv implements IGitMv {
    ...
    public class GitMvParser implements IParser {
        ...
        /**
         * Gets a <code>GitMvResponse</code> object containing the information from the git-mv response text parsed by
         * this IParser instance. It is expected that GitMv does not notify when a move was successful. This follows the
         * response that git-mv itself gives. If the move/rename fails for any reason, proper exception messages are
         * generated and thrown.
         * 
         * @return The <code>GitMvResponse</code> object containing the git-mv's response information. It is expected
         *         that GitMv does not notify when a move was successful. This follows the response that git-mv itself
         *         gives. If the move/rename fails for any reason, proper exception messages are generated and thrown.
