...
public interface IGitStatus {
    ...
    /**
     * 
     * This method returns <code>GitStatusResponse</code> object after parsing the options and then executing the
     * &lt;git-status&gt; command.
     * 
     ...
     * @param paths <code>List</code> of files or file-pattern
     * @return <code>GitStatusResponse</code> Response object returned by &lt;git-status&gt; command.
     * @throws <code>JavaGitException</code> Thrown when there is an error while running the &lt;git-status&gt; command.
     * @throws <code>IOException</code> There are many reasons for which an <code>IOException</code> may be thrown.
     *         Examples include:
     *         <ul>
     ...
     * @param repositoryPath Path to the root of the repository
     * @param options <code>GitStatusOptions</code> Options passed to &lt;git-status&gt; command
     * @param file <code>File</code> whose status need to be checked.
     * @return <code>GitStatusResponse</code> Response object returned by &lt;git-status&gt; command.
     * @throws <code>JavaGitException</code> Thrown when there is an error while running the &lt;git-status&gt; command.
     * @throws <code>IOException</code> There are many reasons for which an <code>IOException</code> may be thrown.
     *         Examples include:
    ...
    /**
     * 
     * This method returns <code>GitStatusResponse</code> object with no options passed to &lt;git-status&gt; command.
     * 
     * @param repositoryPath Path to the root of the repository
     * @return <code>GitStatusResponse</code> Response object returned by &lt;git-status&gt; command.
     * @throws <code>JavaGitException</code> Thrown when there is an error while running the &lt;git-status&gt; command.
