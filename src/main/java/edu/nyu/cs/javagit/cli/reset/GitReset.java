 ...
 */
public class GitReset implements IGitReset {
    ...
    public class GitResetParser implements IParser {
        ...
        /**
         * Gets a <code>GitResetResponseImpl</code> object containing the information from the reset response text
         * parsed by this IParser instance.
         * 
