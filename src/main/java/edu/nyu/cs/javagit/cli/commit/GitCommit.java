 ...
 */
public class GitCommit implements IGitCommit {
    ...
    public class GitCommitParser implements IParser {
        ...
        /**
         * Gets a <code>GitCommitResponse</code> object containing the information from the commit response text parsed
         * by this IParser instance.
         * 
