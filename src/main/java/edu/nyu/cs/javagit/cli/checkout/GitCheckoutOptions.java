...
public class GitCheckoutOptions {
    ...
    /**
     * Track options for setting configuration so that &lt;git-pull&gt; retrieves data automatically from starting
     * point.
     */
    ...
    /**
     * Use this option, if merging need to be done between the current branch, working tree contents, and the new
     * branch. Also, brings you to the new branch.
     */
     ...
     * 
     * @param newBranch New branch of type <code>Ref</code> that will be created by &lt;git-checkout&gt;.
     */
     ...
     * 
     * @param optQ True if quiet option should be set, false otherwise.
     */
     ...
     * 
     * @param optF True if force should be set, false otherwise.
     */
     ...
     * 
     * @return true If refLog option need to be set, else false.
     */
    public boolean optL() {
        return optL;
    }
     ...
     * 
     * @param optL True if reflog option should be set, else false.
     */
     ...
     * 
     * @param optM True if merge need to be used, else false.
     */
