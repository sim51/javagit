...
public interface IGitBranch {
     ...
     * @throws JavaGitException Thrown when there is an error executing git-branch.
     */
    public GitBranchResponse createBranch(File repositoryPath, Ref branchName) throws IOException, JavaGitException;
     ...
     * @throws JavaGitException Thrown when there is an error executing git-branch.
     */
    public GitBranchResponse createBranch(File repositoryPath, GitBranchOptions options, Ref branchName)
            throws IOException, JavaGitException;
     ...
     * @throws JavaGitException Thrown when there is an error executing git-branch.
     */
    public GitBranchResponse createBranch(File repositoryPath, Ref branchName, Ref startPoint) throws IOException,
            JavaGitException;

    /**
     * Creates a branch according to given option. Allow the startPoint to be null to indicate to use the current
     * working branch as the branch start point.
     * 
     * @param repositoryPath A <code>File</code> instance for the path to the repository. If null is passed, a
     *        <code>NullPointerException</code> will be thrown.
     * @param options The options for a git-branch command. If the value is null, a <code>NullPointerException</code>
     ...
     * @throws JavaGitException Thrown when there is an error executing git-branch.
     */
    public GitBranchResponse createBranch(File repositoryPath, GitBranchOptions options, Ref branchName, Ref startPoint)
            throws IOException, JavaGitException;
}
