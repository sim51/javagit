...
import edu.nyu.cs.javagit.cli.commit.GitCommitResponseImpl;
...
public class GitCommit {
    ...
    /**
     * Automatically stage all tracked files that have been changed and then commit all files staged in the git
     * repository's index.
     * 
     ...
     *        must represent the absolute path to the desired directory as returned by the <code>File.getPath()</code>
     *        method. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param options The options to commit with. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param message The message to attach to the commit. A non-zero length argument is required for this parameter,
     *        otherwise a <code>NullPointerException</code> or <code>IllegalArgumentException</code> will be thrown.
     * @return The results from the commit.
     * @exception IOException There are many reasons for which an <code>IOException</code> may be thrown. Examples
     ...
     * @exception JavaGitException Thrown when there is an error making the commit.
     */
    public GitCommitResponse commit(File repository, GitCommitOptions options, String message) throws IOException,
            JavaGitException {
     ...
     * @exception JavaGitException Thrown when there is an error making the commit.
     */
    public GitCommitResponse commit(File repository, GitCommitOptions options, String message, List<File> paths)
    ...
    /**
     * Commits all staged changes (changes already defined in the index) into the specified repository.
     * 
     * @param repository A <code>File</code> instance for the path to the repository root (the parent directory of the
     *        .git directory) or a sub-directory in the working tree of the repository to commit against. This argument
     *        must represent the absolute path to the desired directory as returned by the <code>File.getPath()</code>
     ...
     * @exception JavaGitException Thrown when there is an error making the commit.
     */
    public GitCommitResponse commit(File repository, String message) throws IOException, JavaGitException {
        CheckUtilities.checkNullArgument(repository, "repository");
        CheckUtilities.checkStringArgument(message, "message");
    ...
    /**
     * Commits only the changes in the specified paths into the specified repository. Any staged changes (changes
     * already defined in the index) are ignored.
     * 
     * @param repository A <code>File</code> instance for the path to the repository root (the parent directory of the
     *        .git directory) or a sub-directory in the working tree of the repository to commit against. This argument
     *        must represent the absolute path to the desired directory as returned by the <code>File.getPath()</code>
     ...
     * @exception JavaGitException Thrown when there is an error making the commit.
     */
    public GitCommitResponse commitOnly(File repository, String message, List<File> paths) throws IOException,
            JavaGitException {
        CheckUtilities.checkNullArgument(repository, "repository");
        CheckUtilities.checkStringArgument(message, "message");
        CheckUtilities.checkNullListArgument(paths, "paths");
