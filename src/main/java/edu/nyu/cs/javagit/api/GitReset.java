...
/**
 * <code>GitReset</code> provides an API to perform git-reset functionality against a git repository: reset the current
 * HEAD to the specified state.
 */
public class GitReset {

    /*
     * TODO (jhl388): Determine if "repository" is the right name to call the initial File argument to the reset
     * methods. It may be better to call it something like "workingDirectory" or something to indicate that it can be
     * something further down the git repository working tree other than the root directory.
     */
     ...
     *        .git directory) or a sub-directory in the working tree of the repository to perform reset against. This
     ...
     *        argument must represent the absolute path to the desired directory as returned by the
     *        <code>File.getPath()</code> method. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param options The options for a git-reset command. If the value is null, a <code>NullPointerException</code>
     *        will be thrown.
     * @return The results of the reset.
     * @exception IOException There are many reasons for which an <code>IOException</code> may be thrown. Examples
     *            include:
     ...
     * @exception JavaGitException Thrown when there is an error making the commit.
     */
    public static GitResetResponse gitReset(File repository, GitResetOptions options) throws IOException,
            JavaGitException {
        CheckUtilities.checkNullArgument(repository, "repository");
     ...
     *        argument must represent the absolute path to the desired directory as returned by the
     *        <code>File.getPath()</code> method. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param commitName The name of the commit to reset to. If the value is null, a <code>NullPointerException</code>
     *        will be thrown.
     * @param paths A list of paths to folders or files to reset. The paths specified in this list must all be relative
     *        to the path specified in the <code>repository</code> parameter as returned by <code>File.getPath()</code>.
     *        A non-null and non-empty list is required for this parameter, otherwise a
     ...
     * @exception JavaGitException Thrown when there is an error making the commit.
     */
    public static GitResetResponse gitReset(File repository, List<File> paths) throws IOException, JavaGitException {
        CheckUtilities.checkNullArgument(repository, "repository");
        CheckUtilities.checkNullListArgument(paths, "paths");
     ...
     * @exception JavaGitException Thrown when there is an error making the commit.
     */
    public static GitResetResponse gitResetHard(File repository, Ref commitName) throws IOException, JavaGitException {
        CheckUtilities.checkNullArgument(repository, "repository");
     ...
     * @exception JavaGitException Thrown when there is an error making the commit.
     */
    public static GitResetResponse gitResetSoft(File repository, Ref commitName) throws IOException, JavaGitException {
        CheckUtilities.checkNullArgument(repository, "repository");
        CheckUtilities.checkNullArgument(commitName, "commitName");
