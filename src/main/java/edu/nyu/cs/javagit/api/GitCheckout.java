...
/**
 * <code>GitCheckout</code> provides an interface for checking out files from a particular branch in the repository or
...
public final class GitCheckout {
     ...
     * @param branch name of the branch that will be checked out OR if creating a new branch then the starting for the
     *        new branch will be this branch.
     * @return <code>GitCheckoutResponse</code> object
     * @throws JavaGitException thrown if - <li>if the output for &lt;git-checkout&gt; command generated an error.</li>
     *         <li>if options provided are incorrect.</li> <li>if processBuilder not able to run the command.</li> </ul>
     ...
     * @throws JavaGitException thrown if - <li>if the output for &lt;git-checkout&gt; command generated an error.</li>
     *         <li>if processBuilder not able to run the command.</li> </ul>
     * @throws IOException thrown if -
     *         <ul>
     *         <li>paths given do not have proper permissions.</li>
     *         <li>paths given do not exist at all.</li>
     *         </ul>
     */
    public GitCheckoutResponse checkout(File repositoryPath, List<File> paths) throws IOException, JavaGitException {
        CheckUtilities.checkFileValidity(repositoryPath);
     ...
     * 
     * @param repositoryPath path to the Git repository.
     * @param options <code>GitCheckoutOptions</code> that are passed to &lt;git-checkout&gt; command
     * @param branch <code>Ref</code> branch-name from where the file will be checked out
     * @param file <code>File</code> to be checked out.
     * @return <code>GitCheckoutResponse</code> object
     * @throws <code>JavaGitException</code> thrown if - <li>if the output for &lt;git-checkout&gt; command generated an
     *         error.</li> <li>if options provided are incorrect</li> <li>if processBuilder not able to run the command.
     *         </li> </ul>
     ...
     *         </ul>
     */
    public GitCheckoutResponse checkout(File repositoryPath, GitCheckoutOptions options, Ref branch, File file)
            throws IOException, JavaGitException {
        CheckUtilities.checkFileValidity(repositoryPath);
        CheckUtilities.validateArgumentRefType(branch, RefType.BRANCH, "Branch name");
        IClient client = ClientManager.getInstance().getPreferredClient();
     ...
     * @param options <code>GitCheckoutOptions</code> that are passed to &lt;git-checkout&gt; command
     * @param branch <code>Ref</code> branch-name from where the file will be checked out
     * @param paths <code>List</code> of file paths that are to be checked out.
     * @return GitCheckoutResponse object
     * @throws JavaGitException thrown if - <li>if the output for &lt;git-checkout&gt; command generated an error.</li>
     *         <li>if options provided are incorrect</li> <li>if processBuilder not able to run the command.</li> </ul>
     * @throws IOException Thrown if -
     ...
     *         </ul>
     */
    public GitCheckoutResponse checkout(File repositoryPath, GitCheckoutOptions options, Ref branch, List<File> paths)
            throws IOException, JavaGitException {
        CheckUtilities.checkFileValidity(repositoryPath);
     ...
     * 
     * @param repositoryPath Path to the Git repository.
     * @param ref A branch, or sha1 object.
     * @param paths <code>List</code> of file paths that are to be checked out.
     * @return <code>GitCheckoutResponse</code> object
     * @throws JavaGitException Thrown if - <li>the output for &lt;git-checkout&gt; command generated an error.</li> <li>
     *         processBuilder not able to run the command.</li> </ul>
     * @throws IOException Thrown if -
     *         <ul>
     *         <li>paths given do not have proper permissions.</li>
     *         <li>paths given do not exist at all.</li>
     *         </ul>
     */
    public GitCheckoutResponse checkout(File repositoryPath, Ref ref, List<File> paths) throws JavaGitException,
            IOException {
        CheckUtilities.checkFileValidity(repositoryPath);
        if (ref != null && (ref.getRefType() != RefType.BRANCH && ref.getRefType() != RefType.SHA1)) {
            throw new JavaGitException(100000, ExceptionMessageMap.getMessage("100000") + " RefType passed: "
                    + ref.getRefType());
        }
        CheckUtilities.checkNullListArgument(paths, "List of files");
        IClient client = ClientManager.getInstance().getPreferredClient();
