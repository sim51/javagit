...
public final class WorkingTree {
    ...
    /**
     * Automatically stage files that have been modified and deleted, but new files you have not told git about are not
     * affected
     * 
     * @param comment Developer's comment about the change
     * 
    ...
    public void checkout(Ref ref) throws IOException, JavaGitException {
        ...
        /*
         * TODO (rs2705): Figure out why this function is setting this.path. When does the WorkingTree path change?
         */
