...
public final class GitStatus {
     ...
     * &lt;git-status&gt; command.
     * 
     * @param repositoryPath Directory pointing to the root of the repository.
     * @param options Options that are passed to &lt;git-status&gt; command.
     * @param paths List of paths or patterns
     * @return <code>GitStatusResponse</code> object
     * @throws JavaGitException Exception thrown if the repositoryPath is null or if options or paths are invalid.
     ...
     * &lt;git-status&gt; command. It has no options passed as parameter to the method.
     * 
     * @param repositoryPath Directory path to the root of the repository.
     * @param paths List of paths or file patterns.
     * @return <code>GitStatusResponse</code> object
     * @throws JavaGitException Exception thrown if the repositoryPath is null or if options or paths are invalid.
     * @throws IOException Exception is thrown if any of the IO operations fail.
     */
    ...
    /**
     * It returns a <code>GitStatusResonse</code> object that contains all the details of the output of
     * &lt;git-status&gt; command. It does not pass any options or file paths. This is the most generic execution of
     * &lt;git-status&gt; command.
     * 
     * @param repositoryPath Directory path to the root of the repository.
     * @return <code>GitStatusResponse</code> object
    ...
    /**
     * It returns a <code>GitStatusResonse</code> object that contains all the details of the output of
     * &lt;git-status&gt; command. It is equivalent of executing &lt;git-status&gt; command with '-a' option.
     * 
     * @param repositoryPath Directory path to the root of the repository.
     * @return <code>GitStatusResponse</code> object
     * @throws JavaGitException Exception thrown if the repositoryPath is null or if options or paths are invalid.
    ...
    /**
     * It returns a <code>GitStatusResonse</code> object that contains all the details of the output of
     * &lt;git-status&gt; command, but filters output for a single file
     * 
     * @param repositoryPath Directory path to the root of the repository.
     * @param path
     * @return <code>GitStatusResponse</code> object
     ...
     * @throws IOException Exception is thrown if any of the IO operations fail.
     */
    public GitFileSystemObject.Status getFileStatus(File repositoryPath, File path) throws JavaGitException,
            IOException {
        ...
        /*
         * TODO: quote from Michael Schidlowsky: "this block of if statements is a little smelly... I'd prefer to see
         * something like return response.asStatus()...
         */
        /*
         * if (response.getUntrackedFilesSize() > 0) { return Status.UNTRACKED; }
         * 
         * if (response.getNewFilesToCommitSize() > 0) { return Status.NEW_TO_COMMIT; }
         * 
         * if (response.getDeletedFilesNotUpdatedSize() > 0) { return Status.DELETED; }
         * 
         * if (response.getDeletedFilesToCommitSize() > 0) { return Status.DELETED_TO_COMMIT; }
         * 
         * if (response.getModifiedFilesNotUpdatedSize() > 0) { return Status.MODIFIED; }
         * 
         * if (response.getModifiedFilesToCommitSize() > 0) { return Status.MODIFIED_TO_COMMIT; }
         * 
         * // default return Status.IN_REPOSITORY;
         */
    }
}
