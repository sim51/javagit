...
public abstract class GitStatusResponse implements CommandResponse {
    ...
    /**
     * Get the name of the deleted file that will be committed next time git-commit is executed currently located at the
    ...
    /**
     * Get the name of the file that is modified and added to the repository by &lt;git-add&gt; command and will be
     * committed to repository next time &lt;git-commit&gt; is executed. This file is at the given index in the list of
     * the files.
     * 
     * @param index Index in the list of files must be positive and less than the number of new files to commit
     * @return the name of the file.
     */
    ...
    /**
     * Returns the name of the file that is existing in the repository and has been locally modified. This file is one
     * of the files that has been locally modified and is located at given index in the list.
     * 
     * @param index Index in the list must be positive and less than the number of new files to commit
     * @return the name of the file
     */
    ...
    /**
     * Returns the name of the file at the specified index that has been created locally but has not yet been added to
     * the repository by &lt;git-add&gt;.
     * 
     * @param index Index in the list must be positive and less than the number of new files to commit
     * @return the name of the file
     */
