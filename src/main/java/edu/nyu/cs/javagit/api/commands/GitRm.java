...
public class GitRm {
     ...
     *        .git directory) or a sub-directory in the working tree of the repository to run rm against. This argument
     ...
     * @param path A single file to remove. The specified path must be relative to the path specified in the
     *        <code>repository</code> parameter as returned by <code>File.getPath()</code>. If null is passed, a
     ...
     *        must represent the absolute path to the desired directory as returned by the <code>File.getPath()</code>
     *        method. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param options The options to run rm with. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param path A single file to remove. The specified path must be relative to the path specified in the
     *        <code>repository</code> parameter as returned by <code>File.getPath()</code>. If null is passed, a
     *        <code>NullPointerException</code> will be thrown.
     * @exception IOException There are many reasons for which an <code>IOException</code> may be thrown. Examples
     ...
     *        must represent the absolute path to the desired directory as returned by the <code>File.getPath()</code>
     *        method. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param paths A list of files to remove. The paths specified in this list must all be relative to the path
     *        specified in the <code>repository</code> parameter as returned by <code>File.getPath()</code>. A non-null
     *        and non-empty list is required for this parameter, otherwise a <code>NullPointerException</code> or
     ...
     *        method. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param options The options to run rm with. If null is passed, a <code>NullPointerException</code> will be thrown.
     * @param paths A list of files or folders to remove. The paths specified in this list must all be relative to the
     *        path specified in the <code>repository</code> parameter as returned by <code>File.getPath()</code>. A
