...
/**
 * <code>JavaGitVersion</code> exists solely to provide version information about the JavaGit library.
 */
public final class JavaGitVersion {
    ...
    /**
     * Indicates if this is a SNAPSHOT version. A SNAPSHOT version is a version under development that is not an
     * official release.
     * 
     ...
     * 
     * @return The version string in the format <code>&lt;MAJOR&gt;.&lt;MINOR&gt;.&lt;REVISION&gt;-SNAPSHOT</code> where
     *         &lt;MAJOR&gt; is the major version number, &lt;MINOR&gt; is the minor version number, &lt;REVISION&gt; is
     *         the revision number and -SNAPSHOT is the value inserted if this is a non-release version.
     */
