...
public class CliGitAdd implements IGitAdd {
    ...
    public static class GitAddParser implements IParser {
        ...
        /**
         * Gets a <code>GitAddResponse</code> object containing the info generated by &lt;git-add&gt; command. If there
         * was an error generated while running &lt;git-add&gt; then it throws an exception.
         * 
